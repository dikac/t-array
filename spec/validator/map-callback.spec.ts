...
describe("compiler compatibility", function() {
    ...
    describe("explicit typed", function() {
        ...
        describe("auto partial", function() {
            ...
            let validator = MapMessage(validators,
                (value, validators) => <(Validatable & Value & Message<string>)[]>Standard(value, validators, true),
                And, (v)=>MessageMap(v)
            );
    ...
    describe("all invalid", function() {
        ...
        describe("complete", function() {
            it(`and validation`, () => {
                ...
                expect(and.message[2]).toBe('value is not type of "string"');
            ...
            it(`or validation `, () => {
                ...
                expect(or.message[2]).toBe('value is not type of "string"');
    ...
    describe("mixed", function() {
        ...
        let validators = [
            ...
            MapMessage([
                ValidatorType('string'),
                ValidatorType('number'),
            ], (value, validators) => Standard(value, validators, false), And, MessageMap)
        ];
