...
import MapAll from "../../../dist/list/validator/map-all";
...
describe("compiler compatibility", function() {
    ...
    describe("implicit partial", function() {
        ...
        let property = new MapAll(validator, (v)=>And(<Validatable[]>v));
    ...
    describe("explicit complete", function() {
        ...
        describe("direct", function() {
            ...
            let property = new MapAll<TypeValidator>(validator, (v)=>And(<Validatable[]>v));
...
describe("all valid", function() {
    ...
    it(`check handler or`, () => {
        ...
        let property = new MapAll(validator,(v)=>Or(<Validatable[]>v));
        let validatable = property.validate(value);
...
describe("all invalid", function() {
    ...
    it(`check validate return`, () => {
        ...
        if(validatable.validatables[2]) {
            ...
            expect(validatable.validatables[2].message).toBe('address invalid');
        } else {
