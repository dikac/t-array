...
export declare type Interface<ValidatorsT extends Validator[], Result extends Instance[], MessageT, ValidatableT extends Validatable, ValueT extends BaseList<ValidatorsT>> = Readonly<Validators<ValidatorsT>> & Readonly<Value<ListParameter<ValidatorsT>>> & Readonly<Validatable> & Readonly<Validatables<Result>> & Readonly<Message<MessageT>> & Readonly<ValidatableContainer<ValidatableT>> & Readonly<Messages<Result>> & Readonly<Validation<Function<[Result], ValidatableT>>> & Readonly<{
    map: Function<[ListParameter<ValidatorsT>, ValidatorsT], Result>;
}>;
export default class MapCallback<ValidatorsT extends Validator[] = Validator[], Result extends Instance[] = Instance[], MessageT = unknown, ValidatableT extends Validatable = Validatable, ValueT extends ListParameter<ValidatorsT> = ListParameter<ValidatorsT>> implements Interface<ValidatorsT, Result, MessageT, ValidatableT, ValueT> {
    ...
    constructor(value: ValueT, validators: ValidatorsT, map: Function<[ListParameter<ValidatorsT>, ValidatorsT], Result>, validation: Function<[Result], ValidatableT>, message: Function<[Result], MessageT>);
}
