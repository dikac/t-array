...
export default class NotEmpty<MessageT> implements Validator<Array<any>, Array<any>, boolean, boolean, NotEmptyValidatable<MessageT, Array<any>>>, Message<Function<[Readonly<Value<Array<any>>> & Readonly<Validatable>], MessageT>> {
