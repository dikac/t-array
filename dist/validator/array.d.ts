...
export default class Array_<MessageT> implements Validator<unknown, Array<any>, Readonly<Instance<unknown, MessageT>>>, Message<(result: Readonly<Value> & Readonly<Validatable>) => MessageT> {
