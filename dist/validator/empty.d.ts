...
export default class Empty<MessageT> implements Validator<Array<any>, [], boolean, boolean, EmptyValidatable<MessageT, Array<any>>>, Message<Function<[Readonly<Value<Array<any>>> & Readonly<Validatable>], MessageT>> {
