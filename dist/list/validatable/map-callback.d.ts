...
export default class MapCallback<Container extends Validator[] = Validator[], Result extends ValidatableInterface[] = ValidatableInterface[], Validatable extends ValidatableInterface = ValidatableInterface> implements Validators<Container>, ValueInterface<RecordParameter<Container>>, ValidatableInterface, Interface<Result> {
