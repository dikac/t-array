 ...
 *
 */
export default function Filter<Type, Object extends List.List<Type>>(record: Object, validation: Guard<unknown, Type>, filter: Fn<[Type], boolean>, empty?: boolean): List.Partial<Object>;
