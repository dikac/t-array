...
export default class ListPartial<Container extends Validator[]> extends Default<Container, RecursiveInferArgument<Container>, Object.Partial<RecursiveInferReturn<Container>, 'deep'> & Validatable> {
